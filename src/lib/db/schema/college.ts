...
import { getColleges } from "@/lib/api/college/queries";
...
// this type infers the return from getColleges() - meaning it will include any joins
export type CompleteCollege = Awaited<
  ReturnType<typeof getColleges>
>["colleges"][number];
